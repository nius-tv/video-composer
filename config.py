...
CATEGORY_VIDEO_DIR_PATH = '{}/categories/30fps-512x1024'.format(LIBRARY_DIR_PATH)
...
MASK_FILE_PATH = '{}/mask/30fps-512x1024-v2/mask.{}'.format(LIBRARY_DIR_PATH, VIDEO_FMT)
...
PRESENTER_BACKGROUND_VIDEO_FILE_PATH = '{}/presenter-bgs/25fps-512x1024/4.{}'.format(LIBRARY_DIR_PATH, VIDEO_FMT)
...
TRANSITIONS_MAX_START = 8 # in seconds
