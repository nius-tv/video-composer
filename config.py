...
PIXEL_FMT = 'argb'
PRESENTER_BACKGROUND_VIDEO_FILE_PATH = '{}/presenter-bgs/25fps-512x1024/1.{}'.format(LIBRARY_DIR_PATH, VIDEO_FMT)
...
STORY_VIDEO_WITH_CATEGORY_NO_AUDIO_FILE_PATH = '{}/story-with-category-no-audio.{}'.format(STORY_DIR_PATH, VIDEO_FMT)
